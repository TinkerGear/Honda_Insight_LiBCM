	...
	switch (LiDisplayCurrentPageNum)
	{
		...
		case LIDISPLAY_GRIDCHARGE_PAGE_ID:
			...
			switch (LiDisplayElementToUpdate)
			{
                ...
                case 7: LiDisplay_updateStringVal(LIDISPLAY_GRIDCHARGE_PAGE_ID, "t19", 0, String((LTC68042result_packVoltage_get() * adc_getLatestBatteryCurrent_amps())*0.001)); break;
                case 8: 
